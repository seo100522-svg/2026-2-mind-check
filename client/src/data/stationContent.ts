...
export const STATION_COPY: Record<SupportedLocale, {
  ...
  ko: {
    ...
    welcomeEyebrow: "2026-2학기 마음건강 지원 프로그램", welcomeTitle: "마음체크인:\n마음체크리스트", welcomeLead: "잠시 나에게 집중해 보는 가벼운 마음 체크 시간이에요.", start: "가볍게 시작하기",
    ...
    resultTitle: "검사 결과 안내", resultLead: "각 점수는 최근의 경험을 이해하기 위한 참고자료입니다. 점수와 일상에서 느끼는 변화를 함께 살펴보세요.", mindPassTitle: "마음패스를 받아 오락을 즐기세요!", mindPassLead: "본 페이지를 스태프에게 보여주고 ‘마음패스’를 받아 오락을 즐기세요!", counselingTitle: "개인상담 신청", counselingLead: "학생상담센터에서 현재의 어려움을 함께 정리해 볼 수 있습니다.", counselingButton: "학생상담센터 상담 신청",
  },
  en: {
    brand: "Mind Check-in", brandSub: "Mind Checklist", privacy: "Student Counselling Center", admin: "Owner only",
    welcomeEyebrow: "2026 Semester 2 Mind-Health Support Program", welcomeTitle: "Mind Check-in:\nMind Checklist", welcomeLead: "Take a gentle moment to focus on yourself and see how you have been lately.", start: "Start gently",
  ...
  ja: {
    ...
    resultTitle: "検査結果のご案内", resultLead: "各点数は最近の経験を理解するための参考資料です。日常で感じる変化とあわせて見てみましょう。", mindPassTitle: "マインドパスを受け取って遊びを楽しみましょう！", mindPassLead: "このページをスタッフに見せて「マインドパス」を受け取り、遊びを楽しんでください！", counselingTitle: "個別相談の申込み", counselingLead: "学生相談センターで、今の困難を一緒に整理することができます。", counselingButton: "学生相談センターに相談を申し込む",
  },
};
