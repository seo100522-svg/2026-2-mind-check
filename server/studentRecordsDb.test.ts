...
describe("한글 학생 통합 기록", () => {
  it("stores one student submission with scores and satisfaction responses 1 through 6", () => {
    ...
    const record = buildKoreanStudentRecord({
      anonymousSessionId: "session", locale: "ko", studentName: "홍길동", studentId: "20261234", department: "성장학과",
    ...
    expect(record).toMatchObject({ studentName: "홍길동", studentId: "20261234", department: "성장학과", cesdScore: 19, pssScore: 14, satisfaction1: 5, satisfaction2: 4, satisfaction3: 3, satisfaction4: 2, satisfaction5: 1, satisfaction6: "다음에도 참여하고 싶습니다." });
  });
});
