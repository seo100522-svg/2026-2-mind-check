...
describe("buildRawAssessmentXlsx", () => {
  it("creates an Excel binary with Korean text, a text student ID, scores, and answer columns", () => {
    const bytes = buildRawAssessmentXlsx([{
      id: 1, studentName: "홍길동", studentId: "020261234", department: "성장학과", contactNumber: "010-1234-5678", locale: "ko", cesdScore: 16, pssScore: 12, satisfactionScore: 5, satisfactionAnswerCount: 1, satisfactionComment: "한글 의견",
    ...
    expect(worksheet["F1"]?.v).toBe("연락처_당첨안내용");
    expect(worksheet["F2"]?.v).toBe("010-1234-5678");
    ...
    expect(workbook.Sheets["주관식 소감"]?.["E2"]?.v).toBe("010-1234-5678");
